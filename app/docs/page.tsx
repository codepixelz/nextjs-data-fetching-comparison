      ...
      <div className="container mx-auto p-6 py-12 max-w-7xl">
        ...
        <section id="official-docs" className="mb-16">
          ...
          <p className="text-muted-foreground mb-6">
            Reference links to official documentation for Next.js, React, and TanStack Query.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2 text-sm">
                  ...
                  >
                    <div className="font-medium text-primary hover:underline">Data Fetching</div>
                    <div className="text-muted-foreground text-xs">Fetching data on server and client</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Caching</div>
                    <div className="text-muted-foreground text-xs">Request memoization & data cache</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Server Components</div>
                    <div className="text-muted-foreground text-xs">React Server Components in Next.js</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Streaming & Suspense</div>
                    <div className="text-muted-foreground text-xs">Progressive rendering with Suspense</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">ISR & Revalidation</div>
                    <div className="text-muted-foreground text-xs">Incremental Static Regeneration</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Server Actions</div>
                    <div className="text-muted-foreground text-xs">Mutations & revalidation</div>
                  </a>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2 text-sm">
                  ...
                  >
                    <div className="font-medium text-primary hover:underline">Server Components</div>
                    <div className="text-muted-foreground text-xs">Components that run on the server</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Suspense</div>
                    <div className="text-muted-foreground text-xs">Loading boundaries for async content</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">use Hook</div>
                    <div className="text-muted-foreground text-xs">Read resources like promises</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">&apos;use client&apos; Directive</div>
                    <div className="text-muted-foreground text-xs">Mark client component boundaries</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">&apos;use server&apos; Directive</div>
                    <div className="text-muted-foreground text-xs">Mark server actions</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">React with Frameworks</div>
                    <div className="text-muted-foreground text-xs">Using React with Next.js</div>
                  </a>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <svg className="w-5 h-5" viewBox="0 0 256 230" xmlns="http://www.w3.org/2000/svg">
                    <path d="M202.076 0H53.924C24.136 0 0 24.136 0 53.924v122.152C0 205.864 24.136 230 53.924 230h148.152C231.864 230 256 205.864 256 176.076V53.924C256 24.136 231.864 0 202.076 0" fill="#FF4154"/>
                    <path d="M128 36c-19.882 0-36 16.118-36 36s16.118 36 36 36 36-16.118 36-36-16.118-36-36-36m0 100c-19.882 0-36 16.118-36 36s16.118 36 36 36 36-16.118 36-36-16.118-36-36-36m-64-50c-19.882 0-36 16.118-36 36s16.118 36 36 36 36-16.118 36-36-16.118-36-36-36m128 0c-19.882 0-36 16.118-36 36s16.118 36 36 36 36-16.118 36-36-16.118-36-36-36" fill="#FFF"/>
                  </svg>
                  TanStack Query v5
                </CardTitle>
                <CardDescription>Data Synchronization & Caching</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2 text-sm">
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Overview</div>
                    <div className="text-muted-foreground text-xs">Introduction to TanStack Query</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">SSR & Hydration</div>
                    <div className="text-muted-foreground text-xs">Server-side rendering setup</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Prefetching</div>
                    <div className="text-muted-foreground text-xs">Prefetch data before it&apos;s needed</div>
                  </a>
                  <a
                    ...
                    className="block p-2 rounded hover:bg-muted transition-colors"
                  >
                    <div className="font-medium text-primary hover:underline">Advanced SSR</div>
                    <div className="text-muted-foreground text-xs">Streaming, Server Components</div>
                  </a>
                  <a
                  ...
                  >
                    <div className="font-medium text-primary hover:underline">Caching</div>
                    <div className="text-muted-foreground text-xs">staleTime, gcTime, and invalidation</div>
                  </a>
                  <a
                  ...
                  >
                    <div className="font-medium text-primary hover:underline">Suspense</div>
                    <div className="text-muted-foreground text-xs">Using Suspense with TanStack Query</div>
                  </a>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>More learning resources for advanced topics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                ...
                >
                  <div className="font-medium text-primary hover:underline">Core Web Vitals</div>
                  <div className="text-muted-foreground text-xs">Google&apos;s performance metrics guide</div>
                </a>
                <a
                  ...
                  className="p-3 border rounded-lg hover:bg-muted transition-colors"
                >
                  <div className="font-medium text-primary hover:underline">JavaScript SEO</div>
                  <div className="text-muted-foreground text-xs">Google&apos;s guide for JS-heavy sites</div>
                </a>
                <a
                  ...
                  className="p-3 border rounded-lg hover:bg-muted transition-colors"
                >
                  <div className="font-medium text-primary hover:underline">Streams API</div>
                  <div className="text-muted-foreground text-xs">MDN reference for streaming</div>
                </a>
                <a
                  ...
                  className="p-3 border rounded-lg hover:bg-muted transition-colors"
                >
                  <div className="font-medium text-primary hover:underline">HTTP Caching</div>
                  <div className="text-muted-foreground text-xs">MDN guide to HTTP caching</div>
                </a>
              </div>
            </CardContent>
          </Card>
